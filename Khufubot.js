...
if (isBanChat) return reply(mess.banChat)
                ...
                if (!isUrl(args[0]) && !args[0].includes('whatsapp.com')) return replay(`فين الينك`)
                reply(mess.wait)
...
if (isBanChat) return reply(mess.banChat)
	...
	break
		case 'كل🥺يوم🥺هموم': 
	throw `والحزن مالا قلبي░ سندت كل الناس ملقتش حد  جمبي🥺`
	break
case 'شكرا🥺علي🥺العموم': 
	throw `و̲୭ٰ۬ێلٖا « مع « الٖسٰلٖامۿٰٕہِٰ۬ۛ « انٰتم « ملٖڪٜو̲୭شٖ « امانٰ « غډࢪڪٜم « سٰاب « علٖامۿٰٕہِٰ۬ۛ « ⚫`
	break
...
case 'sc': case 'script': case 'donate': case 'donate': case 'cekupdate': case 'updatebot': case 'cekbot': case 'sourcecode': {
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
teks = `*「 حجات مهمه 🌚❤ 」*\n\n مرحبًا بك في بوت وتس! نحن سعداء جدًا بوجودك هنا. ستجد أننا نقدم لك خدمة سريعة وفعالة، ونحن دائمًا على استعداد لمساعدتك في أي شيء تحتاجه. نحن نفخر بتقديم تقنية حديثة ومتطورة لتحسين تجربتك معنا، ونأمل أن تجد بوت وتس مفيدًا ومثمرًا. شكرًا لاختيارك بوت الوتس الخاص بنا ونتمني لك يوم سعيد  ❤`
let buttons = [
							...
							},
							{
								...
								"rows": [
									...
									},
									{
										...
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
										"rowId": `${prefix}اوامر😂المالك`
										},
									{
										"title": "اوامر جروب ×፝֟͜×",
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
										"rowId": `${prefix}اوامر😂الجروب`
										},
										{
										"title": "اوامر لوجو ×፝֟͜×",
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
										"rowId": `${prefix}اوامر😂الوجو`
									},
									{
										"title": "اوامر اغاني ×፝֟͜×",
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
										"rowId": `${prefix}قاءمه😂الموسيقه`
									},
									{
										"title": "اوامر تحميل ×፝֟͜×️",
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
									...
									},
									{
										"title": "اوامر صور ×፝֟͜×",
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
										"rowId": `${prefix}اوامر😂صور`
									},
									{
										"title": "تعديل علي صور ×፝֟͜×️",
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
										"rowId": `${prefix}تعديل😂الصور`
									},
										{
											"title": "اوامر ال انمي ×፝֟͜×",
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
										"rowId": `${prefix}قاءمه😂الانمي`
										},
										{
											"title": "اوامر ايمو ×፝֟͜×",
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
										"rowId": `${prefix}ايمو😂اوامر`
										},
										{
										"title": "نمي استيكر ×፝֟͜×️",
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
										"rowId": `${prefix}قاءمه😂الاستيكر`
									     },
									{
										"title": "اوامر😂متنوعه ×፝֟͜×",
										"description": "ᴹᴿ᭄Mostafa ×፝֟͜×",
										"rowId": `${prefix}اوامر😂متنوعه`
									     },
										{
...
╠${prefix}اوامر😂متنوعه
╠${prefix}الالعاب
╠${prefix}قاءمه😂الموسيقه
╠${prefix}هزار
╠${prefix}صوتيات😂
╠${prefix}اهلا
╠${prefix}استيكر😂انمي
╠${prefix}قاءمه😂الاستيكر
╠${prefix}قاءمه😂الانمي
╠${prefix}اوامر😂الجروب
╠═══════✪「 هزار 」
╠ ${prefix}how [text
...
╠ ${prefix}sound160
╠ ${prefix}sound161
ياغالي دي كله صوتيات بالتوفيق🥰
════════════════
════════════════
╠══════✪「 العاب 」
╠ ${prefix}اكسo/Ttt
عشان تلعب انت وصحبك ياغالي🥰
════════════════
╠ ${prefix}🦄🦄
بيحذف دور اكس.اوه ياغالي🥰
════════════════
╠ ${prefix}حكم
بيكتب احكام ولازم تتنفز ياغالي🥰
════════════════
╠ ${prefix}حقيقه😈
لعبه الحقيقه 
════════════════
╠ ${prefix}لعبه2
لعبه حجره ورقه مقص ياغالي 🥰
╠══✪「 ANONYMOUS CHAT 」
╠${prefix}anonymous
╠${prefix}start
╠${prefix}next
...
╠${prefix}رمضان كريم
╠${prefix}اضحك
╠${prefix}كل سنه وانت طيب
╠${prefix}تكبيرات العيد
╠${prefix}اذكار الصباح
╠${prefix}اذكار النوم
╠${prefix}اذكار المساء
╠${prefix}اذكار بعد الصلاه
╠${prefix}صلي علي النبي
╠${prefix}صلي علي محمد
╠${prefix}السلام عليكم ورحمة الله وبركاته
╠${prefix}السلام عليكم 
╠${prefix}سلام عليكم 
╠${prefix}سلام عليكم ورحمة الله وبركاته 
{
 ده جزاء بسيط من الصوتيات المالك يعرف كل الاءومر 
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "قناتي 😚♥","url": `${websitex}`}},{"urlButton": {"displayText": "𝑀𝑂𝐒Ť𝐴𝐹𝐴 💗","url": `${botscript}`}},{"quickReplyButton": {"displayText": "معلومات اكتر💗","id": 'donate'}},{"quickReplyButton": {"displayText": "المالك💗","id": 'owner'}}] )
break
case 'اوامر😂المالك':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
var unicorn = await getBuffer(picak+'Owner Menu')
await khufuBotInc.send5ButImg(from, `╔═══════✪「 اوامر😂المالك 」	
╠ ${prefix}خاص
بيخلي البوت خاص ياغالي 🥰
════════════════
╠ ${prefix}للجميع
...
await khufuBotInc.send5ButImg(from, `╔═══════✪「 اوامر😂الجروب 」	 
╠${prefix}اعدادتجروب
اعدادت جروب ياغالي بس مش شغاله 😂
════════════════
╠${prefix}لينك
...
╠ ${prefix}watercolor
╠ ${prefix}classic
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "قناتي 😚♥","url": `${websitex}`}},{"urlButton": {"displayText": "𝑀𝑂𝐴Ť𝐴𝐹𝐴 💗","url": `${botscript}`}},{"quickReplyButton": {"displayText": "معلومات اكتر💗","id": 'donate'}},{"quickReplyButton": {"displayText": "المالك💗","id": 'owner'}}] )
break
case 'downloadmenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
await khufuBotInc.send5ButImg(from, `╔═══════✪「 قاءمه😂الانمي 」	
╠${prefix}naruto
╠${prefix}yaoi
╠${prefix}neko2
╠${prefix}waifu
...
await khufuBotInc.send5ButImg(from, `╔═══════✪「 قاءمه😂الاستيكر 」	
╠ ${prefix}patrick
╠ ${prefix}emoji
╠ ${prefix}emojimix
╠ ${prefix}attp
...
await khufuBotInc.send5ButImg(from, `╔═══════✪「 استيكر😂انمي 」	
╠${prefix}loli
╠${prefix}bully
╠${prefix}cuddle
╠${prefix}cry
...
await khufuBotInc.send5ButImg(from, `╔═══════✪「 اوامر😂متنوعه 」	
╠${prefix}ابحث
╠${prefix}s
╠${prefix}استيكر
╠${prefix}حذف
...
await khufuBotInc.send5ButImg(from, `╔═══════✪「 هزار 」	
╠ ${prefix}how [text
╠ ${prefix}when [text]
╠ ${prefix}where [text]
╠ ${prefix}is [text]
...
await khufuBotInc.send5ButImg(from, `╔═══════✪「 قاءمه😂الموسيقه 」	
╠ ${prefix}Sound1
╠ ${prefix}Sound2
╠ ${prefix}Sound3
╠ ${prefix}sound4
...
await khufuBotInc.send5ButImg(from, `╔═══════✪「 الالعاب 」	
╠ ${prefix}اكسo/ttt
للعب اكس o
╠ ${prefix}dare
╠ ${prefix}tictactoe
...
╠${prefix}القسم الأول من البوت هو: اوامر المالك* وهي اوامر لايمكن ان يستخدمه شخص غير مالك البوت وتم شرحه بالتفصيل 
القسم الثاني من البوت هو:اوامر الجروب
╠${prefix} **شرح**

                                                (هاتو)وهاذ الاءمر لأضافة عضو جديد للمجموعه
في حالت ان.كان العضو كان موجود مسبقا فعمل رد علي اي رساله له واكتب الاءمر
لكن في حالة انك تريد اضافته وهو جديد فعليك بكتابت @وكتبت الرقم برمز الدوله
مثال هاتو @+123456789 ملاحظه كتابت هاتو ثم هذه العلامه @اولا بعده علامة+ وبعد الرقم
╠${prefix}     (بان)وهاذ الامر لأزلة اي عضو تريد ازلته
اعمل رد علي اي رساله له واكتب الاءمر
لكن في حالة انك تريد طرده برقمه فعليك بكتابت @وكتبت الرقم برمز الدوله
مثال بان @+123456789 ملاحظه كتابت بان ثم هذه العلامه @اولا بعده علامة+ وبعد الرقم
╠${prefix}       ( منع الينكات) ستجده مشروحه لكن ملاحظه كتابت on او off بعد الامر مثال: منع😂لينك😂تيلجرام on ^_^
╠${prefix}
                                                                (مشرف)كتابت مشرف وعمل رد علي رسالة الشخص المراد ترقيته او كتبات مثال: مشرف @+123456789
...
await khufuBotInc.send5ButImg(from, `╔═══════✪「 صوتيات😂 」	
╠ ${prefix}صباح الخير 
╠ ${prefix}مساء الخير 
╠ ${prefix}بوت
╠ ${prefix}رمضان كريم
...
╠ ${prefix}اذكار النوم
╠ ${prefix}بوم
╠ ${prefix}بالتوفيق لو وقفت معك حاجه اكتب Owner ياغالي
╚═════════════✪` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "قناتي 😚♥","url": `${websitex}`}},{"urlButton": {"displayText": "𝑀𝑂𝐒Ť𝐴𝐹𝐴 💗","url": `${botscript}`}},{"quickReplyButton": {"displayText": "معلومات اكتر💗","id": 'donate'}},{"quickReplyButton": {"displayText": "المالك💗","id": 'owner'}}] )
break
case 'tqtt': 
	   if (isBan) return reply(mess.ban)
